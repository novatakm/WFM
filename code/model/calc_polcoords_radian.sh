...
usage() {
    ...
    echo "-o <output angle rasters in radian (in zenith,azimuth format)>"
...
r.mapcalc "${angls[0]} = acos(${rast[2]}/sqrt(${rast[0]}^2+${rast[1]}^2+${rast[2]}^2)) * 3.1415/180"
r.mapcalc "${angls[1]} = atan(${rast[0]}, ${rast[1]}) * 3.1415/180"
