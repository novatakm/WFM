...
do
    $DENV_CODE/dataset/make_SGLI_manufire.sh \
    -i $GISDBASE/../INTMED/make_dataset_for_manuinsp/make_dataset_SGLI_for_manuinsp \
    -o GC1SG1_${obs_date}D_${TILE}_SGLIREFFIRE_Q,GC1SG1_${obs_date}D_${TILE}_SGLIREFFIRE_K \
    -d ${obs_date}D
done